...
namespace Mirror
{
    ...
    public static partial class NetworkClient
    {
        ...
        public static bool AddPlayer()
        {
            ...
            //LocalConnectionToClient connectionToClient = new LocalConnectionToClient();
            //connectionToClient.connectionToServer = (LocalConnectionToServer)connection;
            //NetworkServer.SetLocalConnection(connectionToClient);
            //NetworkServer.OnConnected((LocalConnectionToServer)connectionToClient);
            //((LocalConnectionToServer)connection).QueueConnectedEvent();
            return true;
        }
